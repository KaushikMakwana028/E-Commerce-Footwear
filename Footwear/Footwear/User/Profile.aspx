<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Footwear.User.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    ...
                                    <div class="userData ml-3">
                                        <h2 class="d-block" style:"1.5rem;" style="font-weight:bold">
                                       ...
                                       <%-- Basic User Info Starts--%>
                                        <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-8 col-6" style="color:black;">
                                                <%# Eval("Name") %>
                                            </div>
                                        </div>
                                        <hr />
                                        ...
                                        <hr />
                                          <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Postal/Zip Code</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                <%# Eval("PostCode") %>
                                            </div>
                                            ...
                                            <asp:Repeater ID="rPurchaseHistory" runat="server" OnItemDataBound="rPurchaseHistory_ItemDataBound">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Repeater ID="rOrders" runat="server">
                                                        <HeaderTemplate>
                                                            <table class="table table-sm data-table-export table-bordered table-hover">
