<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Footwear.User.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lbRemove" runat="server" Text="Remove" CommandName="remove"
                ...
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Products.aspx" class="btn btn-info"><i class="fa fa-arrow-circle-left mr-2"></i>Continue Shopping</a>
                        </td>
                        <td>
